...
class QMLProcessor:
    ...
    :type qgs_map_layer: QgsVectorLayer
    """

    def __init__(
        self, qml_xml_string: str, qgs_map_layer: QgsVectorLayer
    ) -> None:
        """
    ...
    def _process_label(self) -> None:
        ...
        for i in range(labeling_nodes.count()):
            ...
            for field_name in self._bool_fields_name:
                expression, field_has_change = self._bool_to_int(
                    field_name, expression
                )
                has_change = has_change or field_has_change
                self._has_change = self._has_change or field_has_change
    ...
    def _process_rules(self, renderer_node: QDomElement) -> None:
        """
        Update rule filter expressions for PK fields.

        :param renderer_node: Renderer XML node.
        :type renderer_node: QDomElement
        """
    ...
    def _process_categories(self, renderer_node: QDomElement) -> None:
        """
